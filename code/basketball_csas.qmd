...
format:
  revealjs:
    ...
    code-fold: true
    scrollable: true
    footer: "NBA Shot Analysis · Ankith Nagabandi"
    logo: ""
execute:
  echo: false
  warning: false
...
### Ankith Nagabandi
- Passionate about Basketball Analytics.
- Developing interactive dashboards and visualizations for shot analysis.
- Exploring data-driven insights in NBA statistics.
...
- Interactive visualizations of shot locations and efficiency metrics.
...
candidates = [
    Path('/Users/ankithnagabandi/Documents/Fall25/5520/New_Project/Project/nba_data.csv'),
...
from pathlib import Path
outdir = Path('/Users/ankithnagabandi/Documents/Fall25/5520/Project/outputs')
...
# # ensure df is available (use notebook df_clean if present)
try:
    df = df_clean
except NameError:
...
# sample player used for yearly trend slide
